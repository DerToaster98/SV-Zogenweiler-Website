...
import { getResponsiblePersonAddress, getClubHouseAddress } from "../../../Constants";
        ...
        return (
            <div className="privacy">
                <div className="page-content">
                    <header>
                        <h1 className="text-color-green">Datenschutz&shy;erkl&auml;rung</h1>
                    </header>
                    <article>                    
                        ...
                        <p>
                            Viele Datenverarbeitungsvorg&auml;nge sind
                        ...
                        <p>
                            Wenn Sie die Verarbeitung Ihrer personenbezogenen Daten eingeschr&auml;nkt haben, d&uuml;rfen diese
                        ...
                        <p>
                            Cookies k&ouml;nnen von uns (First-Party-Cookies) oder
